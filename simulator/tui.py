...
from simulator.view import render_text\nfrom simulator.display import render_text as render_display


HELP = """Commands: show, micro, clock, instruction, reset, release, mem <addr> [len], load <addr> <hex-bytes>, gpio [input|dir|data] [value], key <byte>, display, quit"""
